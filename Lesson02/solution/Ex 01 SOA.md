...
1. Identify roles. For each of the following systems, decide whether it acts as a service provider, service requester, or service broker:
    ...
    - Admission System (Requester)
    - National Patient Registry (NPR) (Provider)
    - Hospital Patient Management System (HPMS) (Provider)
    - Insurance Validation Service (Provider)
    - Bed Management Service (Provider)
    - EMR System (Provider)
